...
- 본 프로젝트는 **구조화된 컴포넌트 기반 UI 시스템**입니다.
- 디자인 가이드는 Figma에 포함되어 있습니다.
- 데이터 연동은 개발자 작업이며, 컴포넌트는 props 기반으로 재사용 가능합니다.
- 각 컴포넌트에는 **상호작용 정의 및 주석**이 포함되어 있습니다.

📌 추가 UI 요청이 있다면 새로운 컴포넌트 요청으로 구분 바랍니다.